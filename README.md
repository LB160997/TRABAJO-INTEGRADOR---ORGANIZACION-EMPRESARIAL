...
El empleado debe disponer de suficientes días para aprobar la solicitud.
Todas las solicitudes quedan registradas en la base de datos.
Las solicitudes aprobadas actualizan automáticamente el saldo disponible.
BPMN Implementado
...
Trabajo Práctico Integrador - Automatización de Procesos Administrativos mediante Chatbots
